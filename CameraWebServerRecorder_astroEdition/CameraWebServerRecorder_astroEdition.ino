...
/////////////////////////
//
// SD File Manager declarations
//
//
//
#include "settings.h"
#include <FS.h>
//#include <SD_MMC.h>  // already done

#include "ESPxWebFlMgr.h"

const word filemanagerport = 8080;

uint8_t SDmanAvail = 0;
...
void setup() {
  ...
  if (card_err != ESP_OK) {
    ...
    SDmanAvail = 0; // flag for the SD file manager
  } else {
    SDmanAvail = 1; // flag for the SD file manager
  }
...
//#############
//##
//## Astro-camera setup + SD file Manager setup
//##
//##
  Serial.print("setup(): tick period in milliseconds: ");
...
void loop() {
  ...
  //SDfilemanagerActive = SDfmActive;

  if (( SDmanAvail > 0) && ( SDfilemanagerActive > 0)) {
    delay(1000);
